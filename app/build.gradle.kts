...
android {
    ...
    signingConfigs {
        create("release") {
            storeFile     = file(System.getenv("KEYSTORE_PATH") ?: "island-release.jks")
            storePassword = System.getenv("KEYSTORE_PASSWORD") ?: "IslandApp2024!"
            keyAlias      = System.getenv("KEY_ALIAS") ?: "island_key"
            keyPassword   = System.getenv("KEY_PASSWORD") ?: "IslandApp2024!"
        }
    }
